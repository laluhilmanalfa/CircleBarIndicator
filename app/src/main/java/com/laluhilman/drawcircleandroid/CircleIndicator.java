...
public class CircleIndicator extends View {
    ...
    private void loadAttributeValue(AttributeSet attrs, Context context){
        ...
        progresBarPosition = ta.getFloat(R.styleable.CircleIndicator_barProgress, progresBarPosition);
        progressBarSize = ta.getInt(R.styleable.CircleIndicator_barSize, progressBarSize);
    }
